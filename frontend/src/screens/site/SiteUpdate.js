...
export default function SiteUpdate({ match, history }) {
	...
	const updateHandler = (e) => {
		...
		if (!siteId || !siteName || !siteAddress || !siteContactNumber || !budget || !siteManager) return;
	};
	if (staffInfo) {
		return (
						...
						<Card.Body>
							<Form onSubmit={updateHandler}>
								...
								<Form.Group controlId="siteId">
									...
									<Form.Control type="siteId" value={siteId} onChange={(e) => setSiteId(e.target.value)} />
								</Form.Group>

								<Form.Group controlId="sitename">
									<Form.Label> Site Name</Form.Label>
									<Form.Control type="sitename" value={siteName} onChange={(e) => setSiteName(e.target.value)} />
								</Form.Group>

								<Form.Group controlId="SiteAddress">
									<Form.Label>Site Address</Form.Label>
									<Form.Control type="sitename" value={siteAddress} onChange={(e) => setSiteAddress(e.target.value)} />
								</Form.Group>
								...
								<Form.Group controlId="budget">
									...
									<Form.Control type="budget" value={budget} onChange={(e) => setBudget(e.target.value)} />
								</Form.Group>
