      ...
      <header className="masthead">
        <div className="container">
          <div className="masthead-subheading">
            Welcome To Eagle Building Contracting!
          </div>
          ...
          <div className="row text-center">
            <div className="col-md-4">
              ...
              <p className="text-muted">
                Setup your work crews by assigning employees, equipment, rental
                and materials onto sites.
              </p>
            </div>
            <div className="col-md-4">
              <span className="fa-stack fa-4x">
              ...
              <p className="text-muted">
                Various kind of equipments are provided within organization to
            ...
            <div className="col-md-4">
              ...
              <p className="text-muted">
                Ask your questions related to your dream building and get the
      ...
      <section className="page-section " id="workout">
        <div className="container">
          <div className="text-center">
            ...
            <h3 className="section-subheading text-muted">
              Look at our successful stories with our precious clients.
            </h3>
          </div>
          <div className="row">
