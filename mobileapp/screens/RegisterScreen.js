        ...
        <KeyboardAvoidingView enabled>
          ...
          <View style={authstyles.SectionStyle}>
            <TextInput
              ...
              returnKeyType="next"
              onSubmitEditing={() =>
                dobInputRef.current && dobInputRef.current.focus()
              }
              blurOnSubmit={false}
            />
          </View>
          ...
          <View style={authstyles.SectionStyle}>
            <TextInput
              ...
              returnKeyType="next"
              onSubmitEditing={() =>
                telephoneInputRef.current && telephoneInputRef.current.focus()
              }
              blurOnSubmit={false}
            />
          </View>
          ...
          {errortext != "" ? (
            <Text style={authstyles.errorTextStyle}> {errortext} </Text>
          ) : null}
          <TouchableOpacity
