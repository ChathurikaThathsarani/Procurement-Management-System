...
const getOrders = async () => {
	try {
		...
		const { data } = await axios.get(api_base_url + "orders/" + userdata._id, header);
		console.log(data);
		return data;
	} catch (error) {
		console.log(error);
...
const getDraftOrders = async () => {
	try {
		...
		const { data } = await axios.get(api_base_url + "orders/draft/" + userdata._id, header);
		console.log(data);
		return data;
	} catch (error) {
...
const deleteDraftOrder = async (id) => {
	try {
		...
		const { data } = await axios.delete(api_base_url + "order/draft/delete/" + id, header);
		console.log(data);
		return data;
	} catch (error) {
		console.log(error);
...
const getProductForOrder = async (id) => {
	try {
		...
		const { data } = await axios.get(api_base_url + "orders/draft/products/" + id, header);
		console.log(data);
		return data;
	} catch (error) {
		console.log(error);
...
const getSuppliers = async () => {
	try {
		...
		const { data } = await axios.get(api_base_url + "order/draft/suppliers", header);
		console.log(data);
		return data;
	} catch (error) {
		console.log(error);
...
const approveOrder = async (id, status) => {
	try {
		...
		const { data } = await axios.put(api_base_url + "order/approved/" + id, { status }, header);
		console.log("her");
		console.log(data);
		return data;
	} catch (error) {
...
const draftOrderToPending = async (orderid, productName, productQty) => {
	try {
		...
		const { data } = await axios.put(api_base_url + "order/pending/" + orderid, { productName, productQty }, header);
		console.log("her");
		console.log(data);
		return data;
	} catch (error) {
